...
BULLET_IMPACT_SOUND = pygame.mixer.Sound(
    os.path.join('Assets', 'impact sound.wav'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(
    os.path.join('Assets', 'laser shot.wav'))
START_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'start sound.wav'))
...
FPS = 60
Velocity = 5  # 5 pixels every click or frame if you hold that key down
BULLET_VEL = 7
MAX_BULLETS = 3
...
def main():
    ...
    yellow = pygame.Rect(100, 300, 50, 40)
    START_SOUND.play()
    red_bullets = []
    yellow_bullets = []
